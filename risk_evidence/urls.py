...
urlpatterns = patterns('',
    ...
    url(r'^supply_chain_impact/(\w+)/$', 'risk_evidence.views.sci_list_country', name='sci_list_country'),
    url(r'^probability/$', 'risk_evidence.views.probability_list', name='probability_list'),
    url(r'^probability/(\w+)/$', 'risk_evidence.views.probability_list_country', name='probability_list_country'),
